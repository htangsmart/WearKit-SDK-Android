...
class PressureAdapter : RecyclerView.Adapter<PressureAdapter.ItemViewHolder>() {

    var sources: List<PressureEntity>? = null


    fun addActivity(result: List<PressureEntity>?) {
        this.sources = result
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.viewBind.stepTv.text = holder.viewBind.stepTv.context.getString(R.string.pressure, item.pressure)
    }
