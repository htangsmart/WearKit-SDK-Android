package com.topstep.wearkit.sample.utils.permission
...
object PermissionHelper {
     ...
     * Request permission for ble Scan and Connect
     */
    fun requestBle(activity: FragmentActivity, grantResult: ((Boolean) -> Unit)? = null) {
        requestPermission(activity, getBle(), grantResult)
    }
