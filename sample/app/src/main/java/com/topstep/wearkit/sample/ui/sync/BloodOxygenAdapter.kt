...
class BloodOxygenAdapter : RecyclerView.Adapter<BloodOxygenAdapter.ItemViewHolder>() {

    var sources: List<BloodOxygenEntity>? = null


    fun addActivity(result: List<BloodOxygenEntity>?) {
        this.sources = result
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.viewBind.stepTv.text = holder.viewBind.stepTv.context.getString(R.string.blood_oxygen, item.value)
    }
